...
<template>
  <div class="w-full flex items-center justify-start">
    <div class="flex items-start gap-2.5">
      ...
      />
      <div
        class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-light-background rounded-e-xl rounded-es-xl dark:bg-dark-background"
      >
        ...
        <div class="flex items-start my-2.5 bg-gray-100 dark:bg-dark-secondary rounded-md p-2">
          <div class="me-2">
            <span
            ...
            <span
              class="flex text-xs items-center justify-center font-normal text-gray-500 dark:text-gray-400 gap-2"
            >
              12 Pages
              <svg
          ...
          <div class="inline-flex self-center items-center">
            <button
              class="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 focus:ring-0 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-600 dark:hover:bg-gray-500"
              type="button"
            >
              <svg
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-1">
            <button
              type="button"
              class="flex items-center text-xs font-normal text-gray-500 dark:text-gray-400 bg-gray-200 dark:bg-dark-secondary rounded-full px-3 py-1.5 space-x-2"
            >
              <span>👍</span>
              <span class="font-semibold text-light-text dark:text-dark-text"> 2 </span>
            </button>
            <button
              type="button"
              class="flex items-center text-xs font-normal text-gray-500 dark:text-gray-400 bg-gray-200 dark:bg-dark-secondary rounded-full px-3 py-1.5 space-x-2"
